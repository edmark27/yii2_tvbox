            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="card">
                    ...
                    <div class="view overlay hm-white-slight">
                        <?= Html::img("@web/img/{$card->image}", ['alt' => $card->name, 'class' => 'img-fluid']) ?>
                        <a href="<?=Url::to(['site/box', 'id' => $card->id]) ?>">
                            <div class="mask"></div>
                        </a>
                    </div>
                    <!--/.Card image-->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div><i class="fa fa-microchip fa-1x fa-fw" aria-hidden="true"></i> <?= $card->chipset->cpu?></div>
                                <div><i class="fa fa-database fa-1x fa-fw" aria-hidden="true"></i> <?= $card->specification->ram?> RAM</div>
                            </div>
                            <div class="col-5">
                                <div><i class="fa fa-hdd-o fa-1x fa-fw" aria-hidden="true"></i> <?= $card->specification->rom?> ROM</div>
                                <div><i class="fa fa-android fa-1x fa-fw" aria-hidden="true"></i> <?= $card->specification->android?> vers.</div>
                            </div>
                        </div>
                        <div class="row">
                            <a href="<?=Url::to(['site/add', 'id' => $card->id]) ?>" data-id="<?=$card->id?>" class="col flex-row-reverse add-to-specs">
                                <div class="mbottom waves-effect waves-light p-2 ">Сравнить <i class="fa fa-plus"></i></div>
                            </a>
                            <a href="<?=Url::to(['site/box', 'id' => $card->id]) ?>" class="col d-flex flex-row-reverse">
